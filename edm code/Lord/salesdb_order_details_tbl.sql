...
CREATE TABLE `order_details_tbl` (
  ...
  `quantity` float(3,2) DEFAULT NULL CHECK (`quantity` > 0),
...
INSERT INTO `order_details_tbl` VALUES (1001,501,1.00),(1002,502,2.00),(1001,502,1.00),(1001,501,1.00),(1002,502,2.00),(1001,502,1.00);
...
-- Dump completed on 2025-04-02 20:38:15
